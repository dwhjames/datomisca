...
trait DDReaderImplicits {
  ...
  implicit val DatomicData2JBigInt:     DDReader[DatomicData, JBigInt]     = DDReader(_.asInstanceOf[DBigInt] .underlying.underlying)
  implicit val DatomicData2JBigDec:     DDReader[DatomicData, JBigDecimal] = DDReader(_.asInstanceOf[DBigDec] .underlying.underlying)
  ...
  implicit val DBigInt2JBigInt:         DDReader[DBigInt,  JBigInt]     = DDReader(_.underlying.underlying)
  implicit val DBigDec2JBigDec:         DDReader[DBigDec,  JBigDecimal] = DDReader(_.underlying.underlying)
...
trait DDWriterImplicits{
  ...
  implicit val Int2DInt         = DDWriter[DInt,     Int]           ((l: Int)         => DInt(l))
  ...
  implicit val Int2DatomicData     = DDWriter[DatomicData, Int]         ((l: Int)         => DInt(l))
