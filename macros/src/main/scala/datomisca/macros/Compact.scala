/*
 * Taken from https://github.com/scalamacros/sbt-example-paradise210
 */

package datomisca.macros

import scala.reflect.api.{Universe => ApiUniverse}
import scala.reflect.macros.Context

private[datomisca] trait QuasiquoteCompat {
  val c: Context
  ...
  object quasiquoteCompat {
    ...
    object Liftable {
      ...
      implicit lazy val liftBigInt: Liftable[BigInt] = new LiftableConstant[BigInt]
      implicit lazy val liftBigDec: Liftable[BigDecimal] = new LiftableConstant[BigDecimal]
